...
import { Zap, Sparkles, FileText, BarChart3, ArrowRight, CheckCircle, Briefcase } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-surface overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="absolute top-40 right-1/4 w-72 h-72 bg-teal-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <footer className="border-t border-surface-border py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold text-white">PrepAI</span>
          </div>
          <p className="text-slate-500 text-sm">© 2026 PrepAI. Built with MERN + Groq AI.</p>
        </div>
      </footer>
    </div>
  );
