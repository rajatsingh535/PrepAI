...
export default function AuthLayout() {
  return (
    <div className="min-h-screen bg-surface flex">
      {/* ── Left Brand Panel ─────────────────────────── */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-900 via-brand-800 to-teal-900 
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-teal-400 rounded-full blur-3xl" />
        </div>
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-3xl font-display font-bold text-white">PrepAI</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span className="text-xl font-display font-bold gradient-text">PrepAI</span>
          </div>
